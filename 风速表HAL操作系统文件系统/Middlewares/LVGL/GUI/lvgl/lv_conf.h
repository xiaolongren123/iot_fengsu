...
#define LV_MEM_CUSTOM           0                           /* 0：使用LVGL自带的内存管理，1：使用自研内存管理 */
    ...
    #define LV_MEM_SIZE        (16U * 1024U)                /* 所管理的空间大小由这里分配，单位：字节 */
...
#define LV_USE_ASSERT_NULL                  0   /* 检查参数是否为NULL */
#define LV_USE_ASSERT_MALLOC                0   /* 检查内存是否分配成功 */
...
#define LV_BUILD_EXAMPLES                   0   /* 允许用库构建示例 */
